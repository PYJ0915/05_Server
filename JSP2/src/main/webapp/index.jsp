...
<body>
	...
	<pre>
HTML : html, css, js 코드 작성 가능 + 정적 페이지 (미리 만들어둔 형태 그대로)

JSP : html, css, js, java, el, jstl 모두 작성 가능! + 동적 페이지 (요청에 따라 응답화면을 다르게 보여줄 수 있음)
	</pre>
	
	<hr>
	
	<%-- form태그 메소드 속성 생략 시 기본값 GET --%>
	...
	<h1>
	<%-- a태그 클릭 시 /el/scope 주소로 GET 방식 요청 --%>
